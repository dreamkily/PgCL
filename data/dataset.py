...
dataset = {}
# dataset["PACS"] = ["art", "clipart", "product", "real_world"]
#PACS
dataset["PACS"] = ["art_painting", "cartoon", "photo", "sketch"]
#Domainnet
# dataset["PACS"] = ['clipart', 'infograph', 'painting', 'quickdraw', 'real', 'sketch']
...
def get_train_dataloader(args):
    ...
    for dname in dataset_list:
        ...
        train_loader = torch.utils.data.DataLoader(train_dataset, batch_size=args.batch_size, shuffle=True, num_workers=0, pin_memory=True, drop_last=False)
